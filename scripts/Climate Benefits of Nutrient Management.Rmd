...
p1 <- ggplot() +
  geom_sf(data = wsb) +
  geom_sf(data = dat.yr.sf, aes(color = ch42010.lk.yr - ch4TMDLnew.lk.yr, #
                                size = AREASQKM)) +
   geom_sf(data = cbb, fill = "blue", size = NA) + 
  labs(color = "CH4 reduction\n (mg year-1)", size = "Lake size (km2)") +
  theme(panel.background = element_blank(),
        panel.border = element_rect(color = "black", fill = NA),
        legend.justification = c(0,1))
...
p2 <- ggplot() +
  geom_sf(data = wsb) +
  geom_sf(data = dat.yr.sf, aes(color = co22010.lk.yr - co2TMDLnew.lk.yr, #
                                size = AREASQKM)) +
   geom_sf(data = cbb, fill = "blue", size = NA) + 
  labs(color = "CO2 reduction\n (mg year-1)", size = "Lake size (km2)") +
  theme(panel.background = element_blank(),
        panel.border = element_rect(color = "black", fill = NA),
        legend.justification = c(0,1))
...
p3 <- ggplot() +
  geom_sf(data = wsb) +
  geom_sf(data = dat.yr.sf, aes(color = n2o2010.lk.yr - n2oTMDLnew.lk.yr, #
                                size = AREASQKM)) +
   geom_sf(data = cbb, fill = "blue", size = NA) + 
  labs(color = "N2O reduction\n (mg year-1)", size = "Lake size (km2)") +
  theme(panel.background = element_blank(),
        panel.border = element_rect(color = "black", fill = NA),
        legend.justification = c(0,1))
