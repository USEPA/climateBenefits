...
# Clean this up.  This object is in .gitignore.  Reading from Bryan's repo
# while it copies to climateBenefits_VM
...
# Stitch together manuscript figures
...
ggsave(file = "output/figures/supplementalFigure1.tiff", width = 7, height = 5, units = "in")
```
...
ggsave(file = "output/figures/supplementalFigure3.tiff", width = 3, height = 3, units = "in")
```
...
ggsave("output/figures/supplementalFigure4.tiff", width = 3, height = 3, units = "in")
...
ggsave(file = "output/figures/supplemental.fig5.tiff", g, width = 15, height = 6, units = "in")
...
map(dat.pt %>% select(n2odiff_g_m2_y, preds_lakes_g_m2_y_2010_n2o), summary) # 0.01
...
dat.pt %>% filter(AREASQKM >10) %>% summarize(n=n())
